...
public class Translator {
    ...
    public static Fragments translate(Frame frameFactory, String program) throws Exception {
    ...
    public static Fragments translate(Frame frameFactory, File program) throws Exception {
        TypeChecked typechecked = TypeChecker.parseAndCheck(program);
        return new TranslateImplementation(frameFactory, typechecked).translate();
    }
